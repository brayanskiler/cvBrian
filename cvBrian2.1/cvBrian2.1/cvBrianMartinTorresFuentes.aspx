<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cvBrianMartinTorresFuentes.aspx.cs" Inherits="cvBrian2._1.cvBrianMartinTorresFuentes" %>
...
<body>
     <div class="container-fluid container_full">
        <div class="row container_full">
            ...
            <div class="col-sm-9 col_colorProyect aling_center animate__animated animate__fadeInUpBig">

                <div class="accordion " id="accordionExample">
                        <div class="card colorLime2">
                            <div class="card-header colorLime2" id="headingOne">
                                <h2 class="mb-0">
                                    <button class="btn btn-link" style="color:white" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            ...
                            <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                                <div class="card-body">
                                    <ul >
                                        <li>
                                            2 Years of experience programming in Java for school projects and professional projects.
                                        </li>
                                        <li>
                                            2 Years of experience programming in C# for school projects and professional projects.
                                        </li>
                                        <li>
                                            6 months developed in php for school projects.
                                        </li>
                                        <li>
                                            1 year of experience developing school and professional projects in the javaScript programming language and libraries such as jQuery and AJAX.
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <div class="card colorLime4">
                        ...
                        <div class="card colorLime2">
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                                <div class="card-body">
                                     <ul>
                                        <li>
                                            Spanish, native lenguage
                                        </li>
                                        <li>
                                            Grafic Desing 
                                        </li>
                                        <li>
                                            Plastic Arst(paint and drawing)
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="alert text-white colorLime2 animate__animated animate__fadeInRightBig  delay_0-5s" role="alert">
                    <h4 class="alert-heading">DTS, Digital Title System</h4>
                 ...
                 <div class="alert  text-white colorLime2 animate__animated animate__fadeInRightBig  delay_0-7s" role="alert">
                ...
                <div class="alert text-white colorLime2 animate__animated animate__fadeInRightBig  delay_0-9s" role="alert">
                ...
                <div class="alert text-white colorLime2 animate__animated animate__fadeInRightBig  delay_1-1" role="alert">
                ...
                <hr />
                <div class="container-fluid aling_center">
